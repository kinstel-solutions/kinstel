...
import { LeadTracker } from "@/components/studio/lead-tracker";
        ...
        <section className="border-b border-border/60 py-10 md:py-14">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              Track leads through New, Contacted, Quoted, Won, and Lost.
              Everything is stored only in this browser&apos;s local storage.
