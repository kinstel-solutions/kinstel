              ...
              <div className="flex-1 text-center lg:text-left space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                    Get a <strong>Complete Web Package</strong> starting at just <span className="text-foreground font-bold">₹9999</span>. 
                    Partner with Lucknow's leading web designer to grow your business.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-left max-w-lg mx-auto lg:mx-0 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">Zero Booking Cost</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                    <span className="text-sm font-medium">Pay Later Options</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0" />
                    <span className="text-sm font-medium">Free Domain (1yr)</span>
                  </div>
                </div>
              </div>

              {/* Form Card */}
              <div id="claim-offer" className="w-full max-w-md flex-shrink-0">
                <div className="relative">
                  ...
                  <InquiryForm 
                    className="relative bg-card border-accent/20 shadow-2xl"
                  />
          ...
          <div className="container px-4 mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-muted-foreground">
                We don't just build websites; we build digital assets that work for your business 24/7.
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, i) => (
                <LiquidCard key={i} className="h-full">
                  <CardHeader>
            ...
            <div className="bg-gradient-to-br from-accent/5 to-purple-500/5 border border-accent/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Schedule your consultation today and claim your free digital growth package.
                </p>
                
                <div className="grid sm:grid-cols-3 gap-6 mb-10 text-left">
                  <div className="bg-card/50 p-4 rounded-xl border border-border/50">
                    <span className="block text-2xl font-bold text-accent mb-1">Free</span>
                  ...
                  <div className="bg-card/50 p-4 rounded-xl border border-border/50">
                    <span className="block text-2xl font-bold text-accent mb-1">Free</span>
                    <span className="font-medium">Google My Business Profile</span>
                  </div>
                </div>

                <Button size="lg" className="text-lg px-8 py-6 h-auto shadow-lg shadow-accent/25" asChild>
